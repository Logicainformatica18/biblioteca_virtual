...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/perfil_alumno.css" />
...
<nav class="white" role="navigation">
    <div class="nav-wrapper container">
     ...
     <img src="https://cesca.edu.pe/wp-content/uploads/2018/02/logo.png" width="90px">
      </a>
      <ul class="right hide-on-med-and-down">
                        <li class="scroll"><a href="alumno.php">Alumno </a></li>
                        <li class="scroll"><a href="cursos/alumno_publicaciones.php">Biblioteca</a></li>
        ...
        <li class="scroll"><a href="index.php">Inicio </a></li>
                        <li class="scroll active"><a href="alumno.php">Alumno </a></li>
                        <li class="scroll"><a href="cursos/alumno_publicaciones.php">Biblioteca</a></li>
